window.SocialShareButton =
  ...
  share : (el) ->
    ...
    $.ajax '/share',
      type: 'POST'
      dataType: 'JSON'
      data: { type: $parent.parent().data('objectType'), type_id: $parent.parent().data('objectId'), subtype: $parent.parent().data('objectSubtype'), subtype_id: $parent.parent().data('objectSubid'), social: site }
